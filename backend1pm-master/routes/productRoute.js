...
const { addProduct, getAllProducts, getProductDetails, updateProduct, deleteProduct, productByCategory, getFilteredProducts, getRelatedProducts } = require('../controller/productController')
...
router.post('/getfilterproduct',getFilteredProducts)
